...
const g = (t) => t, p = a({ pathModifier: g, singletonRouter: void 0 }), s = (t = (o) => o, i) => {
  ...
  o && (o.getRouteInfoOrig || (o.getRouteInfoOrig = o.getRouteInfo.bind(o)), o.getRouteInfoOnly || (o.getRouteInfoOnly = ((e) => b({
    ...
    pathnameModifier: t,
    singletonRouter: i
  })).bind(o)), o.getRouteInfoWithOnLoad || (o.getRouteInfoWithOnLoad = h.bind(o)), !o.subOrig && o.sub && (o.subOrig = o.sub.bind(o)), o.subModified || (o.subModified = ((e, f, r) => n(e, f, r, i)).bind(o)), o.sub = ((e, f, r) => n(e, f, r, i)).bind(o), o.onlyAHashChangeOrig || (o.onlyAHashChangeOrig = o.onlyAHashChange.bind(o)), o.onlyAHashChangeNever || (o.onlyAHashChangeNever = m.bind(o)), o.beforePopState = ((e) => u(e, i)).bind(o));
}, H = ({ pathModifier: t, singletonRouter: i, children: o }) => (s(t, i), /* @__PURE__ */ d(p.Provider, { value: { pathModifier: t, singletonRouter: i }, children: o }));
export {
